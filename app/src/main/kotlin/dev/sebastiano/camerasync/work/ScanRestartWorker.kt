...
class ScanRestartWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        // This worker is a safety net to ensure the app is alive and can restart scanning if needed.
        ...
        //    we will just log that we are alive. The system shouldn't kill the PendingIntent scan easily.
        //    
        //    However, to be truly defensive as per plan, we should restart the scan.
        //    The easiest way to do that without DI is to start the service, let it check state, and if it decides it should be idle, it will stop itself and register the scan.
        //    But starting a Foreground Service from Background Worker (if app is in background) is allowed
